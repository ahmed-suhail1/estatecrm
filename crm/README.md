...
- **Satışlar**: Kapanan satışları kaydetme — her danışman yalnızca kendi kayıtlarını görür, yönetici tüm kayıtları filtrelenebilir şekilde görür
...
- `sales` — satış kayıtları (saleDate, customerName, projectName, saleAmount, currency, tlEquivalent, commissionRate, commissionAmount, paymentStatus, deedDate, citizenshipEligibility, agentId, ...) — her danışman yalnızca `agentId` kendisiyle eşleşen kayıtları görebilir; yönetici tümünü görür
